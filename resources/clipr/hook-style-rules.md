# Clipr Hook Style Rules

These rules are internal resources for Clipr, Swipr auto-text, and Stitchr
auto-text. Do not expose style names, template IDs, risk labels, or placeholder
mechanics in the UI.

## Mystery Gap

Principle: hide one important piece of information so the viewer stays to resolve it.
...
Good variables: `behavior`, `cost`, `bad_outcome`, `warning_sign`, `workflow`.
...
Good variables: `mistake`, `fear`, `difficult_moment`, `lesson`, `old_belief`.
