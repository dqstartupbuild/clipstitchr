...
export function OnboardingPlanCheckout({
  ...
  return (
    ...
    >
      ...
      <BillingRenewalDisclosure className="mt-3 text-sm leading-6 text-text-secondary" />
      {error ? (
        <p
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <Link
          ...
          href={
            isCanceled && canceledCheckoutIntentId
              ? `/dashboard/onboarding?billing=canceled&checkout_intent=${encodeURIComponent(canceledCheckoutIntentId)}`
