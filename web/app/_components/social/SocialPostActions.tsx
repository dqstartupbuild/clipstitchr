        ...
        {canResume ? (
          <div className="rounded-lg bg-surface-elevated p-3">
            ...
            <p className="mt-1 text-sm leading-6 text-text-secondary">
              Your plan must be active when this post is due. Missed queue posts
              move to the next open product time and never go out all at once.
            </p>
            ...
            <div className="mt-3">
              <SocialConsentCheckbox
                ...
                hasTikTokBrandedContent={consentContext.hasTikTokBrandedContent}
          ...
          <div>
            <Button
              ...
              onClick={() => {
                if (
                  window.confirm(
                    "Cancel every destination that has not started yet?",
                  )
                ) {
