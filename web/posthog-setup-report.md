...
- `app/_components/dashboard/StitchCard.tsx` — tracks stitch preview views, downloads (with exception capture on failure), music generation, and deletions.
...
- `app/api/music/generate/route.ts` — tracks `library_music_generated` with source, style, and duration.
...
| `stitch_music_generated` | User triggers AI music generation for a stitch. | `app/_components/dashboard/StitchCard.tsx` |
...
| `library_music_generated` | Server: a library music track was successfully generated and saved. | `app/api/music/generate/route.ts` |
...
- [Upload & Music Activity](/insights/8jnyEP19) — video uploads and library music generation volume
