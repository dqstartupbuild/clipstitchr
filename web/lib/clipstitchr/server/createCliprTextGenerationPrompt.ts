...
export function createCliprTextGenerationPrompt({
  ...
  return [
    ...
    '{"templateId":"one candidate id","filledHook":"short hook","variablesUsed":{"placeholder":"value"},"overlayText":"short editable overlay","slides":["first slide hook","supporting point"],"script":"30 or 60 second script","scenePlan":[{"sceneType":"avatar","scriptText":"few lines","visualPrompt":"vertical video prompt","estimatedDurationSeconds":8}]}',
    "Rules:",
    ...
    "- For Clipr, script must start with the hook and scenePlan must mix avatar and b-roll scenes.",
    `Purpose: ${purpose}`,
