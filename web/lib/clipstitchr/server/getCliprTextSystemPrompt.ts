...
export function getCliprTextSystemPrompt(purpose: CliprTextPurpose) {
  ...
  if (purpose === "stitchr") {
    return "You write short emotional visual overlay hooks and posting captions for reaction-based stitched videos. Use the selected UGC and demo context when provided. Do not write scripts, lessons, product explanations, or ad copy. Return valid JSON only.";
  }
