...
export function createUploadAnalysisPrompt({
  ...
  if (mediaKind === "ugc-video") {
    return [
      ...
      `Original file name: ${originalName || "unknown"}.`,
      "Return compact JSON only with this exact shape:",
      '{"name":"short descriptive title","tags":["tag one","tag two"],"videoDescription":"plain-language description of the visible video scene and likely marketing moment","mainPersonDescription":"detailed non-sensitive visual description of the main visible person only","outfitDescription":"visible clothing and accessories only","locationDescription":"visible setting or background only","poseDescription":"visible pose, body position, gesture, or action only","performanceScore":{"overall":0,"hook":0,"cameraPresence":0,"pacing":0,"clarity":0,"platformFit":0,"stitchFit":0,"summary":"one short reason for the score","bestUse":"where this clip fits best","strengths":["short strength"],"fixes":["short fix"],"quickEditSuggestions":{"trimStart":0,"trimEnd":null,"candidates":[],"removeRanges":[],"crop":{"mode":"smart-9x16","removeBlackBars":true,"reason":"Better vertical framing."},"summary":"Tighten the first moment if the full video confirms it."}}}',
      "Use a clear title of 2 to 6 words with no file extension.",
  ...
  if (mediaKind === "demo-video" || mediaKind === "video") {
    return [
      ...
      `Original file name: ${originalName || "unknown"}.`,
      "Return compact JSON only with this exact shape:",
      '{"name":"short descriptive title","tags":["tag one","tag two"],"videoDescription":"plain-language description of what is happening in the demo","productDescription":"detailed grounded description of the visible product, interface, packaging, or service being demonstrated","locationDescription":"visible setting, screen, surface, or background only","poseDescription":"visible action, movement, interaction, or demo step only","performanceScore":{"overall":0,"hook":0,"cameraPresence":0,"pacing":0,"clarity":0,"platformFit":0,"stitchFit":0,"summary":"one short reason for the score","bestUse":"where this demo fits best","strengths":["short strength"],"fixes":["short fix"],"quickEditSuggestions":{"trimStart":0,"trimEnd":null,"candidates":[],"removeRanges":[],"crop":{"mode":"smart-9x16","removeBlackBars":true,"reason":"Better vertical framing."},"summary":"Tighten the first moment if the full video confirms it."}}}',
      "Use a clear title of 2 to 6 words with no file extension.",
      "Use 3 to 8 lowercase tags for visible content, setting, product/category cues, action, style, or mood.",
