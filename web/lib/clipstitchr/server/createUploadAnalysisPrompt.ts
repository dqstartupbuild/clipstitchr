...
export function createUploadAnalysisPrompt({
  ...
  if (mediaKind === "photo") {
    return [
      ...
      '{"name":"short descriptive title","tags":["tag one","tag two"],"avatarDescription":"detailed non-sensitive visual description of the person only","outfitDescription":"visible clothing and accessories only","locationDescription":"visible setting or background only"}',
      ...
      "For avatarDescription, describe the visible person as specifically as possible using stable, non-sensitive visual traits that help recreate the same avatar: face shape, hair style and color, facial hair when visible, eyes, brows, nose, lips, skin tone as visually apparent, build, posture, and distinctive non-sensitive features.",
      "The avatarDescription must include zero information about clothing, accessories, background, location, pose context, scene, camera setting, or activity.",
