...
export function createCliprScriptPrompt({
  ...
  return [
    ...
    "- Keep the script brand-safe for video generation.",
    "- Do not mention minors, age-sensitive situations, protected identity traits, politics, religion, medical diagnoses, sexual content, violence, trauma, self-harm, illegal activity, or shocking claims.",
    "- If the product context involves a sensitive topic, write a neutral general-interest angle that avoids explicit sensitive details.",
    "- If the product context involves fitness, workouts, body goals, health, dieting, or visible results, reframe it as neutral daily planning, habit tracking, schedule consistency, or routine organization.",
    "- Avoid workout, gym, exercise, fitness, body, weight, calories, diet, muscle, and visible-results wording in both the script and avatarPrompt.",
    ...
    "- The avatarPrompt must describe an ordinary brand-safe environment.",
    "- The avatarPrompt should prefer neutral everyday settings like a kitchen table, living room, desk, or entryway.",
    "- The avatarPrompt must not mention minors, protected identity traits, medical settings, political settings, sexual contexts, violence, trauma, emergencies, or illegal activity.",
    "- The avatarPrompt must not use gym, workout, exercise mat, clinic, bedroom, bathroom, locker room, or body-focused settings.",
