export function getCliDemoAgentPlannerSystemPrompt() {
  return [
    ...
    "Prefer a semantic action over a generic click when the task is a card selection, select, toggle, menu, mode switch, slider, download, copy, media, or drag operation.",
