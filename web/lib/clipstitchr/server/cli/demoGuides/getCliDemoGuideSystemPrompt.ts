export function getCliDemoGuideSystemPrompt() {
  return [
    ...
    "Use only actions a browser agent can perform: open local routes, click visible controls, type approved test values, upload approved files, wait for visible text, take one screenshot, or finish a visible step.",
