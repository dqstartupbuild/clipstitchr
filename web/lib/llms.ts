...
export function createLlmsTxt() {
  return [
    ...
    "",
    "## Key Sections",
    "- Browser-local dashboard for upload and workspace status",
    "- Dashboard upload library page with UGC, demo video, and Swapr photo tabs",
    "- Dashboard Swapr studio for person photo and UGC motion pairing",
    "- Dashboard created video library page",
    "- Stitchr studio for UGC-first demo stitching and MP4 export",
