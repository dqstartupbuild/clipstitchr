...
displayTitle: "Guppy, 30 days later."
...
<div className="my-10 rounded-lg border border-border bg-surface p-6">
  <p className="text-2xl font-bold leading-snug text-text-primary md:text-3xl">
    {
...
<figure className="my-10 overflow-hidden rounded-lg border border-border bg-surface">
  ...
  />
  <figcaption className="px-4 py-3 text-sm text-text-tertiary">
    Instagram contributed 22,318 views, 17,039 accounts reached, and 99.8% of
...
<figure className="my-10 overflow-hidden rounded-lg border border-border bg-surface">
  ...
  />
  <figcaption className="px-4 py-3 text-sm text-text-tertiary">
    The 139K view count came from TikTok. Adding Instagram's 22,318 views pushed
    the full total past 161K.
  </figcaption>
</figure>
...
<figure className="my-10 overflow-hidden rounded-lg border border-border bg-surface">
  ...
  />
  <figcaption className="px-4 py-3 text-sm text-text-tertiary">
    ClipStitchr kept the production queue moving with Hook/UGC clips, demo
    videos, and finished stitches in one workspace.
  </figcaption>
</figure>
