...
This is why Hook Lab focuses on public post research. A saved TikTok or
Instagram post can be reviewed scene by scene alongside its public engagement
counts before the user decides what the result means for their own work.
...
<figure className="my-10 overflow-hidden rounded-lg border border-border bg-surface">
  <img
    ...
    alt="ClipStitchr dashboard showing completed Guppy stitches"
    className="mx-auto max-h-[780px] w-full object-contain"
    loading="lazy"
    decoding="async"
  />
