  ...
  return (
    <div className="py-[10px] flex flex-col px-[15px] w-full gap-[10px] bg-bgInstagram rounded-[12px]">
      ...
      {!!renderContent?.[0]?.images?.length ? (
        ...
        <div
          className="bg-newColColor w-full aspect-[calc(16/9)] rounded-[8px] overflow-hidden"
          aria-label="No Instagram media selected"
        />
      )}
      <div
            ...
            <div key={index} className="flex flex-col gap-[12px]">
              <div className="flex gap-[10px] leading-[17px]">
                ...
                <div className="flex flex-col gap-[6px] flex-1">
                  ...
                  <div className="flex font-[400] text-[12px] text-textColor items-center">
