...
describe("convex cliprJobs", () => {
    ...
    expect(ctx.db.insert).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        mainPersonDescription:
          "Avatar clone Avatar in a generated Clipr video.",
        outfitDescription:
          "Prompt-guided outfit generated by Clipr for the selected avatar scene.",
        poseDescription: "Try this",
        productDescription: "Product: Product details",
        ownerId: "owner_123",
        tags: ["ugc", "clipr"],
        videoDescription: expect.stringContaining(
          "Clipr script clip for Product.",
        ),
      }),
    );
    expect(ctx.db.patch).toHaveBeenCalledWith(
  ...
  it("finalizes demo mode jobs into the Demo library with generated details", async () => {
    const { ctx } = createCtx({
      cliprJobs: [
        {
          unique: createJob({
            ...
            avatarPhotoId: "",
            demoClipId: "demo_1",
            demoClipName: "Phone demo",
            generationMode: "demo",
            requestedGenerationMode: "demo",
            requestedVideoModelId: "bytedance/seedance-2.0",
            scenePlan: [
              createScenePlan({
                estimatedDurationSeconds: 8,
                sceneType: "demo",
                scriptText: "Silent phone-in-hand demo remix",
                visualPrompt: "Single handheld phone shot",
              }),
            ],
    ...
    expect(ctx.db.insert).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        id: "clip_demo_1",
        libraryKind: "demo",
        locationDescription: "Single handheld phone shot",
        mainPersonDescription:
        ...
        poseDescription: "Silent phone-in-hand demo remix",
        productDescription: "Product: Product details",
        productId: "product_1",
        tags: ["demo", "clipr"],
        videoDescription: expect.stringContaining(
          "Clipr demo remix for Product.",
        ),
      }),
    );
  });
