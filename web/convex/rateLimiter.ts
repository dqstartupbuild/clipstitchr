...
export const rateLimiter = new RateLimiter(components.rateLimiter, {
  ...
  socialCapabilityRefresh: {
    kind: "token bucket",
    rate: 30,
    period: HOUR,
    capacity: 10,
  },
  socialCapabilityRefreshGlobal: {
    kind: "token bucket",
    rate: 2000,
    period: HOUR,
    capacity: 200,
  ...
  socialScheduleCreateDaily: {
    kind: "token bucket",
    rate: 500,
    period: DAY,
    capacity: 100,
  },
  socialScheduleCreateGlobal: {
    kind: "token bucket",
    rate: 10000,
    period: DAY,
    capacity: 1000,
  ...
  socialAnalyticsRefresh: {
    kind: "token bucket",
    rate: 6,
    period: HOUR,
    capacity: 2,
  },
  socialAnalyticsRefreshGlobal: {
    kind: "token bucket",
    rate: 200,
    period: HOUR,
    capacity: 40,
  ...
  socialStatusCheckByAccount: {
    kind: "token bucket",
    rate: 600,
    period: HOUR,
    capacity: 100,
  },
  socialStatusCheckGlobal: {
    kind: "token bucket",
    rate: 20000,
    period: HOUR,
    capacity: 2000,
