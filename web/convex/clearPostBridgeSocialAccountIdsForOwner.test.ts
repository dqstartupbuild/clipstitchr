...
describe("clearPostBridgeSocialAccountIdsForOwner", () => {
  it("clears stored Post Bridge account IDs from products and product cards", async () => {
    const productQuery = createCollectQuery([
      {
        _id: "product_doc_1",
        postBridgeSocialAccountIds: [101, 202],
      },
      {
        _id: "product_doc_2",
      },
    ...
    const productCardQuery = createCollectQuery([
      {
        ...
        postBridgeSocialAccountIds: [303],
      },
      {
