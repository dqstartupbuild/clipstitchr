...
```bash
STUDIO_PUBLISHING_TEST_POSTGRES_EPHEMERAL=true \
STUDIO_PUBLISHING_TEST_STUDIO_PUBLISHING_DATABASE_URL=postgresql://cliptest:cliptest@127.0.0.1:55432/clipstitchr_publishing_test \
