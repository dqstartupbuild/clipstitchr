...
Create one runtime from the parsed `STUDIO_PUBLISHING_REDIS_URL`, call `connect` during service
...
Every consumer also requires a validated `STUDIO_PUBLISHING_REDIS_NAMESPACE`. This
...
- `STUDIO_PUBLISHING_TEST_STUDIO_PUBLISHING_REDIS_URL` points to an unauthenticated Redis database 0 on
...
STUDIO_PUBLISHING_TEST_REDIS_EPHEMERAL=true \
STUDIO_PUBLISHING_TEST_STUDIO_PUBLISHING_REDIS_URL=redis://127.0.0.1:6389/0 \
