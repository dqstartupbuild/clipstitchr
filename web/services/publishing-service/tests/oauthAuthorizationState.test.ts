...
const REDIRECT_URI =
  "https://clipstitchr.invalid/api/publishing/oauth/tiktok/callback";
...
describe("OAuth authorization request state", () => {
  ...
  it.each([
    ...
    {
      name: "return path",
      overrides: { expectedReturnPath: "/dashboard/publishing/compose" as const },
    },
    ...
    const expected = {
      ...
      expectedPublicOrigin: PUBLIC_ORIGIN,
      expectedReturnPath: "/dashboard/publishing/integrations" as const,
      store,
      nowEpochMilliseconds: NOW + 1_000,
      ...overrides,
    };
