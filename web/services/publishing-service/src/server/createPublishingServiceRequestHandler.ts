...
import { createStudioBetaReadinessDependency } from "../health/createStudioBetaReadinessDependency.js";
...
export const createPublishingServiceRequestHandler = (
  ...
  const readinessDependencies = Object.freeze([
    createStudioBetaReadinessDependency(options.studioBetaEnabled),
  ...
  return (request, response): void => {
    ...
    if (!options.studioBetaEnabled) {
      writeJsonResponse(response, 503, {
        code: "studio_beta_disabled",
