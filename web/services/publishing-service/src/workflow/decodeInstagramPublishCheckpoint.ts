...
export const decodeInstagramPublishCheckpoint = (
  ...
  if (
    ...
    !isNullableString(checkpoint.activeContainerId) ||
    !isNullableString(checkpoint.parentContainerId) ||
    !isNullableString(checkpoint.mediaId) ||
    !isNullableString(checkpoint.permalink)
  ) {
    throw new ProviderRuntimeError("instagram", "invalid_request");
  }
