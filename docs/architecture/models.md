...
| `prunaai/z-image-turbo-img2img:5c958e90e0f904240629ee35c69196e3bd790b5528c0696705ebdb1656871dd8` | Supported | Sends `prompt`, `image`, `strength: 0.6`, `num_inference_steps: 8`, `guidance_scale: 0`, `output_format: "jpg"`, and speed-tier mapped `output_quality`. Prompts use image-to-image wording and tell the model to transform wardrobe, scene, pose, and lighting. |
