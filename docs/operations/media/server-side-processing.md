...
in `docs/operations/automation/provider-workflows.md`.
...
`docs/operations/deployment/media-worker.md` tracks the hosting tradeoffs, including
...
Relevant limits are documented in `docs/operations/security/rate-limits.md`:
...
- Mediabunny guide mirror: `docs/references/media-bunny/guides.md`
- Mediabunny API declarations: `docs/references/media-bunny/api.md`
- Durable workflow notes: `docs/operations/reliability/durable-workflows.md`
- Worker deployment notes: `docs/operations/deployment/media-worker.md`
- Provider/automation notes: `docs/operations/automation/provider-workflows.md`
