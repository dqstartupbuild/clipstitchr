...
documented in `docs/operations/media/server-side-processing.md`.
...
- autopilot enabled;
- global automation window eligibility from
  `docs/planning/automation/clipstitchr-automation-plan.md`;
...
batch. See `docs/operations/reliability/worker-dispatch-recovery.md` for the recovery and
...
Update `docs/operations/security/rate-limits.md` whenever these limits are implemented.
...
- Durable media processing: `docs/operations/media/server-side-processing.md`
