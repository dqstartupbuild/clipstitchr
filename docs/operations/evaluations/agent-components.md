...
Any future agent feature must update `docs/operations/security/rate-limits.md`.
...
7. Add tests for auth, rate-limit failures, tool boundaries, and no-private-data
   responses.
8. Update `docs/operations/security/rate-limits.md` and privacy documentation.
