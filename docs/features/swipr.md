...
9. The user saves the editable Swipe.
10. The saved Swipe appears in the Content Library under the Swipes tab.
11. From the library, the user can open the Swipe detail view, swipe through its
