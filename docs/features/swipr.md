...
9. Batch-generated Swipes also save the generated caption, hashtags, and
   performance note. Manual saves preserve those fields when an existing
   generated Swipe is edited.
...
- Optional caption, hashtags, and performance note generated by batch Swipr.
...
- Background preview.
- Last updated date.
- Caption and hashtag preview when they exist.
...
saved per-slide photo blobs. It also shows saved caption, hashtags, and the
generation note when they exist. It stays within the mobile viewport and does
not require horizontal page scrolling. The Edit action opens Swipr with
...
caption, hashtags, and performance note. Manual Swipes created from scratch may
have no social copy until a future editing control is added for those fields.
