...
3. Upload UGC clips and review their scores.
4. Upload a product demo and review its score.
5. Choose Stitchr batch text style and colors.
6. Queue the first batch and land on the Library Stitches tab.
