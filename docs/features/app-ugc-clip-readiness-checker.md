...
`docs/features/public-tool-quality-register.md`. Future AI, speech, motion, or
...
`docs/features/browser-local-video-inspection.md`.
...
- `docs/features/browser-local-video-inspection.md`
- `docs/features/product-demo-readiness-checker.md`
- `docs/features/9-16-app-demo-video-checker.md`
