...
The structures and examples are original project copy implementing `docs/features/public-tool-batch-16-50-design.md`. Category reminders intentionally avoid professional advice and unsupported performance claims.
