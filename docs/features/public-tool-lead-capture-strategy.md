...
`docs/backend/rate-limits.md` with every enforcement point and limit.
...
`docs/backend/loops-email-integration.md`. No public request may select an
...
- Related implementation documents, the quality register, analytics docs,
  privacy copy, and `docs/backend/rate-limits.md` are updated in the same change.
...
- `docs/content/lead-magnet-portfolio.md`
