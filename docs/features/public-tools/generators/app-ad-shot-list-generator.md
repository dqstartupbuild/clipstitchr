...
`docs/features/public-tools/portfolio/public-tool-quality-register.md`. Adding AI or Hook Library
...
- `docs/features/public-tools/generators/app-ugc-brief-builder.md`
