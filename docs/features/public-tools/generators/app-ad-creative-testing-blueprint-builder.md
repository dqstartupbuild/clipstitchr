...
docs/features/public-tools/generators/app-ad-creative-testing-blueprint-builder.md
```
...
- The [Public Tool Quality Register](../portfolio/public-tool-quality-register.md) records
  this same candid assessment alongside every public tool.
- `docs/features/public-tools/portfolio/public-tool-batch-11-15-design.md` defines the accepted tool
  contract and differentiation from the Test Plan Generator.
- `docs/features/public-tools/generators/app-ad-test-plan-generator.md` documents the downstream weekly
  scheduling tool.
