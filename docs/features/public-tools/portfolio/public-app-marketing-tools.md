...
`docs/features/public-tools/portfolio/public-tool-lead-capture-strategy.md` records the approved next
...
`docs/features/public-tools/portfolio/public-tool-quality-register.md` is the candid internal record
...
- `docs/features/public-tools/generators/app-hook-generator.md` documents deterministic hook
  generation, request validation, and generation quota.
- `docs/features/public-tools/calculators/ad-variant-calculator.md` documents the local formulas and
  practical phased test plan.
- `docs/features/public-tools/portfolio/public-tool-batch-3-10-design.md` records the accepted shared
  architecture, product boundary, tool contracts, and decision log.
- `docs/features/public-tools/portfolio/public-tool-batch-11-15-design.md` records the five remaining
  priority contracts and why they differ from the first ten.
- `docs/features/public-tools/portfolio/public-tool-batch-16-50-design.md` maps all fifty portfolio
...
- `docs/features/public-tools/portfolio/public-tool-quality-register.md` records candid readiness and
  refinement status for every public tool.
- `docs/features/public-tools/portfolio/public-tool-lead-capture-strategy.md` records the approved
...
- `docs/operations/email/integration.md` locks Loops as the future email
...
- `docs/operations/security/rate-limits.md` is the source of truth for both tool-lead and
...
- `docs/integrations/analytics/posthog.md` and `docs/integrations/analytics/tiktok.md` document the fixed
