...
- `docs/features/public-tools/portfolio/public-tool-batch-11-15-design.md` defines the approved
  formulas, bounds, result, and boundary.
- `docs/features/public-tools/calculators/app-ugc-cost-calculator.md` documents the separate detailed
...
- `docs/product/strategy/positioning.md` defines the reusable-source-material and paid
