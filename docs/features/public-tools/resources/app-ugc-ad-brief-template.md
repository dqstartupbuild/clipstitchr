...
boundaries come from `docs/features/public-tools/portfolio/public-tool-batch-16-50-design.md`; ongoing
release evidence is recorded in `docs/features/public-tools/portfolio/public-tool-quality-register.md`.
