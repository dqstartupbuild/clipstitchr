...
The prompts are original project copy created from the approved contract in `docs/features/public-tools/portfolio/public-tool-batch-16-50-design.md`. They do not claim to predict ad performance.
