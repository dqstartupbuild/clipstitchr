...
For `clipstitchr demo agent`, the CLI asks what the demo should show unless the
...
See `docs/operations/security/rate-limits.md` for operational verification steps.
