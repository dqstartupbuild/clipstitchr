...
| Automatic avatar photo generation | Worker-only automation planner before provider work; provider worker creates one generated avatar photo from the latest eligible source photo | 1 generated photo/day/avatar; global 500/day |
