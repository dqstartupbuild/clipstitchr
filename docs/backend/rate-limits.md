...
| Convex record saves | `videoClips.save`, `photoAssets.save`, `stitches.save` | 30/hour/user, burst 10 |
| Convex metadata updates | `updateMetadata` mutations | 120/hour/user, burst 30 |
