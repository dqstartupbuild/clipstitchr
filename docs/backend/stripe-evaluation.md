...
model in `docs/backend/rate-limits.md`.
...
- Update `docs/backend/rate-limits.md` with checkout, portal, webhook, and any
...
- `docs/backend/rate-limits.md`: document billing-related limits.
- `docs/analytics/tiktok.md`: document purchase conversion trigger after
  Stripe confirmation.
