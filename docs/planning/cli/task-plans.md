...
was previously listed in `docs/planning/roadmap/next-task-notes.md`.
...
- When a task adds or changes a user-triggered backend operation, identify the
  ...
  and update `docs/operations/security/rate-limits.md`.
...
- Update README, customer CLI docs, queue/batch feature docs, and
  `docs/operations/security/rate-limits.md` if backend endpoints or limits change.
...
- Update README, customer CLI docs, feature docs, and
  `docs/operations/security/rate-limits.md` if an endpoint or limit changes.
