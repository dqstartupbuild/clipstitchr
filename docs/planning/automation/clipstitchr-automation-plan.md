...
- Continue to enforce ownership and authorization separately from automation
  budgets.
- Update `docs/operations/security/rate-limits.md` when these limits are implemented.
...
- Update `docs/operations/security/rate-limits.md`.
...
The open product decisions are answered in
`docs/planning/automation/open-decisions.md`.
